<?php 
    include "koneksi.php";
    $id = $_GET['id'];
	$detail=mysqli_query($koneksi,"Select * from tb_post where id_post='".$_GET['id']."'");
                ...
                <div class="col-lg-7 text-left mt-1" style="font-size: 12px;">
                    <nav aria-label="breadcrumb">
                      <ol class="breadcrumb">
                        ...
                        <li class="detail-breadcrumb" aria-current="page">&nbsp; › &nbsp;<?= $d['judul_berita'];?></li>
                      </ol>
                    </nav>
                   <section>
                        <div class="container">
                            <div class="row ">
                                <div class="col-md-12 mobile_selengkapnya">
                                    <table >
                                        <tr>
                                            <td class=""><h4 class="text-center"><?= $d['judul_berita'];?></h4></td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <img class="rounded" src="vendor/img/<?= $d['gambar_berita']; ?>" style="float:left;padding:5px 10px 5px 10px;width:450px;margin-top:35px; margin-left: 12%;">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="font-size: 14px;text-align: justify;"><?= $d['isi_berita'];?></td>
                                        </tr>
                                    </table>
                                            <br><br><br><br><br><br>
                            </div>
                        ...
                        <div class="row no-gutters" style="display: flex;">
                            ...
                            <div class="col-md-8 col-sm-3">
                                <div class="card-body mt-n4">
                                    <a href="index.php?id=<?=$populer['id'];?>&&page=selengkapnya_populer">
